...
Note: This document follows the Mathematical Style Guide (Geometrical Model of Nature/20 - Informational Layer/20.1 - Semantic Interfaces/20.1.1 - Schemas & Conventions/Mathematical Style Guide.md). We work in units with field speed v = 1 unless stated otherwise. ε = |e|/6 is the unit charge magnitude.
