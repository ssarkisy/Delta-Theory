...
-   **Neutrino:** A neutrino is a bare Noether Core, possibly with a captured neutral binary as its personality charge. Its profound energy shielding and lack of a net external charge explain why it interacts so weakly with other matter. It is essentially a "cloaked" assembly.
...
-   **Fractional Charge:** The characteristic fractional charges of quarks (e.g., $+2/3\epsilon$ for an up quark, $-1/3\epsilon$ for a down quark) are an emergent property of the geometry. They arise from the time-averaged potential of the personality architrinos. An orbiting personality architrino may spend part of its orbit shielded by the core and part of it externally expressed, resulting in an effective charge that is a fraction of the elementary charge $\epsilon$.
