...
- What we assume:
  - Effective emission strength q_eff(t0)=q/(1+|v_source(t0)|).
  - Reception is likewise dimmed by 1/(1+|v_receiver(t)|).
  - Canonical per-hit law:
    a_{o′←o} ∝ σ_{q_o q_{o′}} |q_o q_{o′}|/(r² (1+|v_o|)(1+|v_{o′}|)) r̂.

- Why it matters:
  - As objects speed up, they both emit and absorb less strongly. That negative feedback loop reduces runaway behavior, enables shielding in assemblies, and helps establish stable operating points.
