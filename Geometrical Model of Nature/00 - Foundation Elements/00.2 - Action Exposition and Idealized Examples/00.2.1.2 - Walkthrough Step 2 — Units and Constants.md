...
- Unit charge magnitude ($\epsilon>0$):
  ...
  - Per-wavefront amplitude and emission cadence are constant (no emitter-speed dimming). The receiver’s speed does not additionally modulate the force magnitude.
