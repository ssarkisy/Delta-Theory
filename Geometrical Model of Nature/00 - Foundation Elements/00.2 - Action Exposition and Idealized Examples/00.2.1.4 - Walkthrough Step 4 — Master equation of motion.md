...
- Velocity modulation (emitter-only):
  - Only the emitter’s speed at emission, $\|\mathbf{v}_o(t_0)\|$, dims the per-wavefront amplitude via $f(\|\mathbf{v}_o(t_0)\|)$ (default $f(\beta)=1/(1+\beta)$ with $\beta=\|\mathbf{v}\|/v$; in $v=1$ units, $\beta=\|\mathbf{v}\|$).
